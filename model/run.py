...
if __name__ == '__main__':
    ...
    args.config_filename = f'../configs/PatchTST/PatchTST_{args.feature}.yaml'
    logger = get_logger_simple('log', f'PatchTST_{args.dataset}_{args.feature}')
    print(f'Baseline:PatchTST\t-Dataset:{args.feature}\t-num of cells:{args.num_cells}\t-dim:{args.dim}')
